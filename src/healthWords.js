...
C0023473:Myeloid Leukemia, Chronic
...
C0022876:Premature Obstetric Labor
...
C0030409:Paracoccidioidomycosis
...
C0019348:Herpes Simplex Infections
...
C0042510:Ventricular Fibrillation`.split('\n').map(x => {
        return x.slice(9)
    }
);
